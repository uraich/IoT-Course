...
echo "Uploading firstAjax.html"
ampy put html/firstAjax.html html/firstAjax.html

echo "Uploading ajax_info.txt"
ampy put html/ajax_info.txt html/ajax_info.txt

echo "Uploading sensor.html"
ampy put html/sensor.html html/sensor.html

echo "Uploading sensorTimer.html"
ampy put html/sensorTimer.html html/sensorTimer.html
