...
echo ""
echo "Uploading sensorEvt.html"
ampy put html/sensorEvt.html /html/sensorEvt.html
echo "Uploading sht30MeasAndPlot_sse.html"
ampy put html/sht30MeasAndPlot_sse.html /html/sht30MeasAndPlot_sse.html
