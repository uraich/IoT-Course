...
# Modified to use microdot instead of picoweb
# U. Raich Nov. 2022
...
def index(req):
  print(req)
  return send_file('html/dummySensor.html', content_type = "text/html; charset=utf-8")

@app.route("/ajax_info.txt")
def index(req):
  print(req)
  return send_file('html/ajax_info.txt', 'r')
