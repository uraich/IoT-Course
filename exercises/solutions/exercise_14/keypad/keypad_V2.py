...
# This version prints the button found and then waits for a button release
# Like this a single value is printed for each button press
# This version waits 
            ...
            for row in range(4):
                ...
                for col in range(4):
                    if self.cols[col].value() == 0:
                        # print("btn: " + self.chars[row][col])
                        if not btn:
                            btn=self.chars[row][col]
